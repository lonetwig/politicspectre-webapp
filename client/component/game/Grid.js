...
export default function Grid({global}){
  const {
    assets,setAdd,info,setInfo,mode,setAssetSize,gridError,maxSize,setMaxSize,select,setSelect,allPos,setAllPos,square,setSquare,nop,ps,squareRef,textCheck,endSelect,clickAsset,canvRef
  }=global
